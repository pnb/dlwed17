# Do not predict future sequences. This results in embeddings that seem to be slightly worse
# features in supervised models, since they do not capture any predictive structure in the data.
import time
import numpy as np
import os
...
run_id = 'bb_nofu_' + str(TIMESTEPS) + 'steps_' + \
